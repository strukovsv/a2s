...
var _user$project$Grid$getSvg = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$height(gheight),
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Convert') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Main$getAsciiText(
					{ctor: '_Tuple0'})
			};
		} else {
			return {
...
var _user$project$Main$Convert = {ctor: 'Convert'};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Main$receiveAsciiText(_user$project$Main$Input)
			]));
};
